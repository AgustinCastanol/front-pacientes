<template>
    ...
    <DataTable :value="pacientes" :paginator="true" :rows="5" :emptyMessage="emptyMessage" class="table">
      ...
      <Column header="Acciones">
        <template #body="rowData">
          ...
          <Button icon="pi pi-angle-double-right" class="p-button-text custom-icon"
                  @click="abrirModalConsulta(rowData)"/>
        </template>
      </Column>
    </DataTable>
  </div>
    ...
    <Dialog v-model="mostrarModalModificar" header="Modificar Paciente" :visible="mostrarModalModificar"
      ...
      <div class="modal-column ">
        ...
        <div>
          ...
          <Dropdown placeholder="Seleccionar Tipo de Sangre" :options="tipoSangre"
                    v-model="pacienteSeleccionado.blood_type" class="p-dropdown"/>
        </div>
        <div>
          <label>Rh:</label>
        ...
        <div>
          <label>Sexo:</label>
          <Dropdown placeholder="Seleccionar Sexo" :options="sexo" v-model="pacienteSeleccionado.sex"
                    class="p-dropdown"/>
        </div>
        <div>
  ...
  <!-- Modal Ver Paciente -->
  <Dialog v-model="mostrarModalVer" header="Ver Paciente" :visible="mostrarModalVer" class="p-dialog"
          style="width: 800px;">
...
const modalAgregarPacientes = ref(false);
...
function actualizarMostrarModal(valor) {
  mostrarModalAgregar.value = valor;
}
