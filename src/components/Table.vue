<template>
  ...
  <AgregarPaciente v-model:abrirModalAgregar="abrirModalAgregar" />
...
import TableConsultation from './TableConsultation.vue';
import { createRouter, createWebHistory } from 'vue-router';
import { useRouter } from 'vue-router';
import AgregarPaciente from './generics/AgregarPaciente.vue'
...
const Agregar = () => {
  console.log('Botón Agregar Paciente clicado');
  abrirModalAgregar.value = !abrirModalAgregar.value;
}
