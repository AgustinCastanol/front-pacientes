...
watchEffect(() => {
  mostrarModalAgregar.value = props.abrirModalAgregar;
});


function abrirModalAgregar() {
  if (agregarPacienteComponent.value) {
    const abrirModalFunc = agregarPacienteComponent.value.abrirModalAgregar;
    ...
    if (abrirModalFunc && typeof abrirModalFunc === 'function') {
      ...
      console.error('Error: abrirModalAgregar no está definido como una función en agregarPacienteComponent');
    }
  } else {
    console.error('Error: agregarPacienteComponent no es una instancia válida');
  }
}
